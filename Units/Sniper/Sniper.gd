...
@onready var panel_hovering: Panel = $PanelHovering
...
func _process(_delta: float) -> void:
	panel_hovering.visible = \
		selectable_component.state == Utils.SelectionState.Hovering
	panel_selected.visible = \
		selectable_component.state == Utils.SelectionState.Selected
